...
public class EmployeeController {
	...
	//@RequestMapping(value = "/editEmployee/{code}/{name}/{location}/{emailId}/{dateOfBirth}", method = RequestMethod.PUT)
	@PutMapping("/editEmployee/{code}/{name}/{location}/{emailId}/{dateOfBirth}")
	public void editEmployee(@PathVariable int code,
			@PathVariable String name,
			@PathVariable String location,
			@PathVariable String emailId,
			@PathVariable String dateOfBirth) throws ParseException {
